...
add_definitions(
        #-D ENABLE_TRACING=TRACE_WITH_STDERR
        -D VIRGL_EGL_DEBUG
        -D ANDROID_FIX
        -D ANDROID_DXTN_DECOMPRESS
)
...
add_executable(libvirgl_test_server.so
        "virglrenderer/src/gl4es-decompress.c"

        "virglrenderer/src/iov.c"
        "virglrenderer/src/virgl_context.c"
        "virglrenderer/src/virgl_fence.c"
...
target_include_directories(libvirgl_test_server.so PRIVATE
        "libepoxy"
        "libepoxy/epoxy"
        "libepoxy/include"
        "virglrenderer/src"
...
target_compile_options(libvirgl_test_server.so PRIVATE "-fPIE" "-DHAVE_CONFIG_H" "-imacros" "${CMAKE_CURRENT_BINARY_DIR}/virglrenderer/config.h")
target_link_libraries(libvirgl_test_server.so PRIVATE epoxy m )
target_link_options(libvirgl_test_server.so PRIVATE "-s")
