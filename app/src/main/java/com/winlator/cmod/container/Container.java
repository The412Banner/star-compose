...
public class Container {
    ...
    public static final String DEFAULT_FPS_COUNTER_CONFIG = "showFPS=1,showCPULoad=0,showGPULoad=0,showRAM=0,showRenderer=0,showBatteryTemp=0,showBatteryVoltage=0";
